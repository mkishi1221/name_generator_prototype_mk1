...
blacklist_pd.sort_values(['keyword', 'wordsAPI_pos', 'occurrence'], ascending=[True, False, False], inplace=True)
...
greylist_pd.sort_values(['keyword', 'wordsAPI_pos', 'occurrence'], ascending=[True, False, False], inplace=True)
...
whitelist_pd.sort_values(['keyword', 'wordsAPI_pos', 'occurrence'], ascending=[True, False, False], inplace=True)
...
shortlist_pd.sort_values(['name', 'length', 'algorithm'], ascending=[False, True, False], inplace=True)
